...
This is a fully functional [Jenkins](http://jenkins.io/) server, based on the Long Term Support release (2.204.4) including [Docker CLI](https://download.docker.com/linux/static/stable/x86_64/) (19.03.6) and [docker-compose](https://github.com/docker/compose/releases) (1.25.4).
