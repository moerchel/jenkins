...
This is a fully functional [Jenkins](http://jenkins.io/) server, based on the Long Term Support release (2.541.3) including [Docker CLI](https://download.docker.com/linux/static/stable/x86_64/) (29.4.0) and [docker-compose](https://github.com/docker/compose/releases) (5.1.2).
