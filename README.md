...
This is a fully functional [Jenkins](http://jenkins.io/) server, based on the Long Term Support release (2.492.1) including [Docker CLI](https://download.docker.com/linux/static/stable/x86_64/) (27.5.1) and [docker-compose](https://github.com/docker/compose/releases) (2.33.0).
